...
const FIELD_REGISTRY: Record<string, FieldMeta> = {
  ...
  wetland_ha:         { section: 'Biodiversity Data', label: 'Wetland Rehabilitation (ha)', format: 'number' },
  agroforestry_hh:    { section: 'Biodiversity Data', label: 'Agroforestry Households', format: 'number' },
  soil_structures:    { section: 'Biodiversity Data', label: 'Soil Conservation Structures', format: 'number' },
  conservation_groups:{ section: 'Biodiversity Data', label: 'Conservation Groups', format: 'number' },
  coverage_change_ha: { section: 'Biodiversity Data', label: 'Coverage Change (ha)', format: 'number' },
  species_trend:      { section: 'Biodiversity Data', label: 'Species Population Trend' },
  habitat_quality:    { section: 'Biodiversity Data', label: 'Habitat Quality (1–10)', format: 'number' },
  ...
  hwc_incidents:      { section: 'Wildlife & Enforcement', label: 'Human-Wildlife Conflict Incidents', format: 'number' },
  illegal_cases:      { section: 'Wildlife & Enforcement', label: 'Illegal Activities Reported', format: 'number' },
  tree_planting_hh:   { section: 'Wildlife & Enforcement', label: 'Tree Planting Households', format: 'number' },
