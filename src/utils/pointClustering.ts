 ...
 */
export function filterByKingdom(occurrences: GBIFOccurrence[], kingdom: string): GBIFOccurrence[] {
 ...
 */
export function shouldCluster(occurrenceCount: number, threshold: number = 500): boolean {
