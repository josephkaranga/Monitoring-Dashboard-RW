...
import { submitRoleChangeRequest, getRoleChangeRequests } from '../services/roleChangeService';
...
export default function RoleChangeRequestForm() {
  ...
  const validate = () => {
    ...
    if (!justification.trim()) errs.justification = 'Justification is required';
      ...
      errs.justification = 'Justification must be at least 20 characters';
    setErrors(errs);
    ...
    return (
      ...
      >
        ...
        <p style={{ color: '#64748b', fontSize: '0.9rem', margin: 0 }}>
          You have a pending role change request. Please wait for a REMA Administrator to review
          your request.
        </p>
      </div>
    );
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <select
            ...
            style={{
              width: '100%',
              padding: '10px 12px',
              border: errors.role ? '1.5px solid #f43f5e' : '1.5px solid #e2e8f0',
              borderRadius: 8,
              fontSize: '0.9rem',
          ...
          {errors.role && (
            <div style={{ fontSize: '0.75rem', color: '#f43f5e', marginTop: 4 }}>{errors.role}</div>
          )}
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <textarea
            ...
            style={{
              width: '100%',
              padding: '10px 12px',
              border: errors.justification ? '1.5px solid #f43f5e' : '1.5px solid #e2e8f0',
              borderRadius: 8,
              fontSize: '0.9rem',
              fontFamily: "'DM Sans', sans-serif",
              outline: 'none',
          ...
          {errors.justification && (
            <div style={{ fontSize: '0.75rem', color: '#f43f5e', marginTop: 4 }}>
              {errors.justification}
            </div>
          )}
        </div>
        ...
        <button
          ...
          style={{
            width: '100%',
            padding: '11px 0',
            background: loading ? '#94a3b8' : 'linear-gradient(135deg, #0f2744, #1e3a5f)',
            color: '#fff',
            border: 'none',
            borderRadius: 8,
            fontSize: '0.9rem',
