...
export function MetricCardSkeleton() {
  return (
    <div style={{ padding: 20, borderRadius: 'var(--radius)', background: 'var(--surface-3)', flex: 1, minWidth: 160 }}>
...
export function CardSkeleton({ lines = 3 }: { lines?: number }) {
  return (
    <div style={{ background: 'var(--surface)', borderRadius: 'var(--radius)', border: '1px solid var(--border)', padding: 18 }}>
