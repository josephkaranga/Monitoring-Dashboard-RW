...
export default function NationalTargetsPage() {
  ...
  const { data: rawIndicators, refetch: refetchIndicators } = useIndicators() as {
    data: Indicator[] | null;
    loading: boolean;
    error: string | null;
    refetch: () => void;
  ...
  const toggleAll = () => {
    if (allExpanded) {
      ...
      setExpandedIds(new Set(targets.map(t => t.id)));
      setAllExpanded(true);
    }
  };
  ...
  const goalCounts = useMemo(() => {
    ...
    targets.forEach(t => {
      if (c[t.goal] !== undefined) c[t.goal]++;
    });
    return c;
  }, [targets]);
  ...
  const indicatorSummary = useMemo(() => {
    ...
    indicators.forEach(i => {
      if (c[i.tier] !== undefined) c[i.tier]++;
    });
    return c;
  }, [indicators]);
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <div
            style={{ fontSize: '1.8rem', fontWeight: 700, fontFamily: "'Playfair Display', serif" }}
          >
            {targets.length || 22}
          </div>
      ...
      {/* GBF alignment */}
      <div
        style={{ ...card, padding: 16, marginBottom: 16, borderLeft: '4px solid var(--sky-dim)' }}
      >
        <div
          style={{
            fontSize: '0.82rem',
          ...
          {[
            {
              ...
              color: '#166534',
              label: 'Goal A',
              desc: 'Reduce threats to biodiversity · Targets 1–4',
            },
            {
              bg: '#e0f2fe',
              color: '#0369a1',
              label: 'Goal B',
              desc: "Meet people's needs through sustainable use · Targets 5–8",
            },
            {
              bg: '#fef9c3',
              color: '#854d0e',
              label: 'Goal C',
              desc: 'Tools and solutions for implementation · Targets 9–12',
            },
            {
              bg: '#f3e8ff',
              color: '#6b21a8',
              label: 'Goal D',
              desc: 'Means of implementation & mainstreaming · Targets 13–22',
            },
          ].map(g => (
      ...
      >
        <i
          ...
          style={{ color: 'var(--sky-dim)', fontSize: '0.85rem', marginRight: 4 }}
        />
        <span
          style={{ fontSize: '0.78rem', fontWeight: 700, color: 'var(--text-2)', marginRight: 8 }}
        >
          Indicator Framework:
        </span>
        {[
      ...
      >
        <div style={{ position: 'relative', flex: 1, minWidth: 200 }}>
          ...
          <input
            type="text"
            placeholder="Search targets or indicators…"
            value={search}
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                fontFamily: "'DM Sans', sans-serif",
                background: goalFilter === val ? 'var(--navy)' : 'var(--surface)',
                color: goalFilter === val ? '#fff' : 'var(--text-2)',
                transition: '0.2s',
              }}
            >
              {lbl}
              ...
              <div key={t.id} id={`target-card-${t.id}`} style={{ ...card, overflow: 'hidden' }}>
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      <span
                        style={{ fontWeight: 700, fontSize: '0.87rem', color: 'var(--text-1)' }}
                      >
                        {t.title}
                      </span>
                      <span
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
                    <div style={{ textAlign: 'right' }}>
                      <div style={{ fontSize: '0.68rem', color: 'var(--text-3)', marginBottom: 3 }}>
                        Progress
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <span style={{ fontSize: '0.75rem', fontWeight: 700, color: progColor }}>
                          {t.progress}%
                        </span>
                      </div>
                      <span
                  ...
                  >
                    ...
                    {t.timeline_milestones && (
                      ...
                      >
                        ...
                        >
                          <i className="fa-solid fa-calendar-days" style={{ fontSize: '0.7rem' }} />{' '}
                          Timeline &amp; Milestones
                        </div>
                          ...
                          {t.timeline_milestones.split(';').map((phase, idx) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <span
                                  style={{ fontSize: '0.78rem', color: '#166534', lineHeight: 1.5 }}
                                >
                                  {desc}
                                </span>
                              </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                          ...
                          <span style={{ fontSize: '1.1rem', fontWeight: 700, color: progColor }}>
                            {t.progress}%
                          </span>
                        </div>
                      </div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                          {t.headline_indicator && (
                            ...
                            >
                              ...
                              >
                                <i className="fa-solid fa-star" style={{ fontSize: '0.55rem' }} />{' '}
                                HEADLINE
                              </div>
                              <p
                                style={{
                    ...
                    {(() => {
                      ...
                      const byTier: Record<IndicatorTier, Indicator[]> = {
                        headline: [],
                        component: [],
                        complementary: [],
                        binary: [],
                      ...
                      linked.forEach(i => {
                        if (byTier[i.tier as IndicatorTier])
                          byTier[i.tier as IndicatorTier].push(i);
                      });
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            <button
                              onClick={() => navigate(`/indicators?goal=${t.goal}&target=${t.id}`)}
                              style={{
                                fontSize: '0.7rem',
                                padding: '3px 10px',
                                borderRadius: 6,
                          ...
                          {(Object.entries(byTier) as [IndicatorTier, Indicator[]][])
