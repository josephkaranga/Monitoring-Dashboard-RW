...
import RoleChangeHistoryView from '../components/RoleChangeHistoryView';
    ...
    <div style={{ padding: 24, maxWidth: 1200, margin: '0 auto' }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ margin: 0, fontSize: '0.9rem', color: '#64748b' }}>
          Request a role change or view your request history. All requests require REMA
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 32 }}>
        ...
        >
          ...
          >
            <strong>Note:</strong> You can only have one pending request at a time. If your request
            is rejected, you can submit a new one.
          </div>
        </div>
      </div>
