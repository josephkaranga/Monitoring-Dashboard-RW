...
const stakeholders = [
  ...
  { name: 'Local Communities', cat: 'Community', catBg: '#fef9c3', catColor: '#854d0e', role: 'Citizen Scientists', resp: 'Biodiversity observations, local knowledge, HWC reporting', module: 'T04', engagement: 'Medium', engBg: '#dbeafe', engColor: '#1e40af', highlight: false },
