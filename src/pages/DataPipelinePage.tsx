    ...
    <div>
      ...
      <div style={{ ...card, padding: 28, marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 22 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.72rem', color: 'var(--text-3)', marginTop: 2 }}>
              Community → Sector → District → National Agencies → REMA National Dashboard
            </p>
          </div>
        </div>
        ...
        >
          {[
            ...
            {
              tier: 'Tier 5',
              label: 'REMA Dashboard',
              sub: 'Visualization\n& CBD reporting',
              icon: 'fa-chart-line',
              gradient: 'linear-gradient(135deg,#0f2744,#1e3a5f)',
              shadow: 'rgba(15,39,68,.3)',
            },
          ].map((t, i) => (
            <React.Fragment key={t.tier}>
              ...
              >
                <i
                  ...
                  style={{ fontSize: '1.4rem', display: 'block', marginBottom: 6 }}
                />
              ...
              {i < 4 && (
                <i className="fa-solid fa-arrow-right" style={{ color: 'var(--text-3)' }} />
              )}
            </React.Fragment>
          ))}
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 8 }}>
          {[
            ...
            >
              ...
              <div style={{ fontSize: '0.68rem', color: 'var(--text-2)', lineHeight: 1.4 }}>
                {label}
              </div>
            </div>
          ))}
            ...
            {[
              {
                ...
                desc: 'All 7 reporting modules — districts, institutions, community',
                sub: 'Deadline: Mar / Jun / Sep / Dec',
              },
              {
                bg: '#0284c7',
                label: 'ANN',
                title: 'Annual National Biodiversity Report',
                desc: 'Consolidated implementation report against 22 NBSAP targets',
                sub: 'Submitted to Cabinet & Parliament',
              },
              {
                bg: '#7c3aed',
                label: '2027',
                title: 'Mid-Term Evaluation',
                desc: 'Comprehensive review of NBSAP implementation progress',
                sub: 'Q3 2027 · All 22 indicators reviewed',
              },
              {
                bg: '#0f2744',
                label: 'CBD',
                title: 'CBD National Report Submission',
                desc: 'KM-GBF progress report to Convention on Biological Diversity',
                sub: 'Due: June 2029 · Final evaluation 2030',
              },
            ].map(item => (
      ...
      <div style={{ ...card, padding: 18 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {[
            {
              label: 'S1 · Indicator Alignment',
              color: '#0ea5e9',
              start: 0,
              width: 16,
              resources: '2 staff · Low cost',
              high: false,
            },
            {
              label: 'S2 · Institutional RACI',
              color: '#7c3aed',
              start: 8,
              width: 16,
              resources: '3 staff · Low cost',
              high: false,
            },
            {
              label: 'S3 · Reporting Templates',
              color: '#059669',
              start: 12,
              width: 22,
              resources: '4 staff · Medium',
              high: false,
            },
            {
              label: 'S4 · M&E Framework',
              color: '#d97706',
              start: 16,
              width: 22,
              resources: '3 staff · Medium',
              high: false,
            },
            {
              label: 'S5 · Dashboard & RBIS',
              color: '#0f2744',
              start: 20,
              width: 50,
              resources: '6 staff · High cost',
              high: true,
            },
            {
              label: 'S6 · Compliance Framework',
              color: '#e11d48',
              start: 29,
              width: 22,
              resources: '3 staff · Medium',
            ...
            {
              label: 'S7 · Capacity Building',
              color: '#10b981',
              start: 0,
              width: 100,
              resources: '5 staff · Medium',
              concurrent: true,
            },
            {
              label: 'S8 · Validation & Testing',
              color: '#8b5cf6',
              start: 58,
              width: 25,
              resources: '4 staff · Medium',
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {s.width < 20 ? '' : `${Math.round(s.width / 4)} months`}
                  </span>
                </div>
              </div>
              <div
                style={{
                  fontSize: '0.7rem',
                  color: s.high ? '#991b1b' : 'var(--text-3)',
                  fontWeight: s.high ? 700 : 400,
                }}
              >
                {s.resources}
              </div>
