...
const stakeholders = [
  { name: 'MINEMA / REMA', cat: 'Government', catBg: '#dbeafe', catColor: '#1e40af', role: 'Lead Agency', resp: 'Overall coordination, RBIS management, CBD reporting', module: 'T01 · All modules', engagement: 'High', engBg: '#dcfce7', engColor: '#166534', highlight: false },
  ...
  { name: 'Local Communities & IPLCs', cat: 'Community', catBg: '#fef9c3', catColor: '#854d0e', role: 'Citizen Scientists', resp: 'Biodiversity observations, indigenous knowledge, HWC reporting', module: 'T04', engagement: 'Medium', engBg: '#dbeafe', engColor: '#1e40af', highlight: false },
