...
INSERT INTO public.risks (id, description, category, likelihood, impact, level, mitigation, owner) VALUES
  ...
  ('R10', 'Gender & IPLC data underreported', 'Capacity', 'Medium', 'Medium', 'Low', 'Mandate disaggregated gender data in T02 and T04 forms; include IPLC liaison in community monitoring training; use Indicator 22 as early warning', 'REMA / NGOs'),
